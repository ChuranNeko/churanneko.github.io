...
:::tip
该[仓库](https://github.com/KaguyaRing/NapCat-Docker-Template)已经提供了NapCat单服务、AstrBot+Napcat、多种模板文件，您可以根据需要选择合适的模板文件进行下载。
:::

::github{repo="KaguyaRing/NapCat-Docker-Template"}
